...
$lang["admin_maintenance_site_closed"] = htmlentities(SITE_NAME, ENT_QUOTES, 'UTF-8') . " will be closed next page view";
$lang["admin_maintenance_site_opened"] = htmlentities(SITE_NAME, ENT_QUOTES, 'UTF-8') . " will be opened next page view";

...
<td id='right'>
    ...
    <?php $h->pluginHook('admin_theme_main_stats', 'sb_users', array('total_users', 'admins', 'supermods', 'moderators')); ?>
    <?php $h->pluginHook('admin_theme_main_stats', 'sb_users', array('approved_users', 'pending_users', 'undermod_users', 'banned_users', 'killspammed_users')); ?>
    ...
    <?php $h->pluginHook('admin_theme_main_stats', 'sb_comments', array('total_comments', 'approved_comments', 'pending_comments')); ?>
    </ul>
</td>

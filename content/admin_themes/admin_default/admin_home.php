...
<td id='right'>
	...
	<ul id="site-stats">
		...
		<?php $h->pluginHook('admin_theme_main_stats', 'post_manager', array('Posts' => array('total_posts', 'approved', 'pending', 'buried', 'archived'))); ?>
		<?php $h->pluginHook('admin_theme_main_stats', 'comments', array('Comments' => array('total_comments', 'approved', 'pending', 'archived'))); ?>
	</ul>
</td>

...
extract($hotaru->vars['admin_account']); // extracts $username_check, etc.
?>
...
<p class="breadcrumbs">
    ...
    &raquo; <?php echo $hotaru->lang["main_user_theme_account"]; ?>
</p>
...
<div class='main_inner'>
    ...
    <?php echo $hotaru->lang["main_user_theme_account_instructions"]; ?>
    <form name='admin_theme_update_form' action='<?php echo BASEURL; ?>admin_index.php' method='post'>    
    <table>
    <tr><td><?php echo $hotaru->lang["main_user_theme_update_username"]; ?>&nbsp; </td><td><input type='text' size=30 name='username' value='<?php echo $username_check; ?>' /></td></tr>
    ...
    <?php $hotaru->pluginHook('users_account_pre_password'); ?>
    <?php $hotaru->pluginHook('users_account_pre_password_user_only'); ?>
    
    <br />
    
    <?php echo $hotaru->lang["main_user_theme_update_password_instruct"]; ?>
    <form name='update_form' action='<?php echo BASEURL; ?>admin_index.php' method='post'>
    <table>
    <tr><td><?php echo $hotaru->lang["main_user_theme_update_old_password"]; ?>&nbsp; </td><td><input type='password' size=30 name='password_old' value='<?php echo $password_check_old; ?>' /></td></tr>
    <tr><td><?php echo $hotaru->lang["main_user_theme_update_new_password"]; ?>&nbsp; </td><td><input type='password' size=30 name='password_new' value='<?php echo $password_check_new; ?>' /></td></tr>

...
<div class='main_inner'>
    ...
    <form name='admin_theme_update_form' action='<?php echo BASEURL; ?>index.php' method='post'>    
    <table>
    ...
    <input type='hidden' name='admin_user_type' value='update_general' />
    ...
    <input type='hidden' name='admin_user_type' value='update_password' />
    <input type='hidden' name='page' value='admin_account'>
    <tr><td>&nbsp;</td><td style='text-align:right;'><input type='submit' value='<?php echo $lang['admin_theme_update_form_submit']; ?>' /></td></tr>            
    </table>
    </form>

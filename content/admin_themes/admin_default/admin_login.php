...
<div class='main_inner'>
    ...
    <table>
        <tr>
        <td><?php echo $hotaru->lang["admin_theme_login_username"]; ?>:&nbsp; </td>
        <td><input type='text' size=30 name='username' value='<?php echo $username_check; ?>' /></td>
        </tr>
        <tr>
        <td><?php echo $hotaru->lang["admin_theme_login_password"]; ?>:&nbsp; </td>
        <td><input type='password' size=30 name='password' value='<?php echo $password_check; ?>' /></td>
        </tr>
        <tr>
        <td>&nbsp; </td>
        <td style='text-align:right;'><input type='submit' value='<?php echo $hotaru->lang['admin_theme_login_form_submit']; ?>' /></td>
        </tr>            
    </table>
    ...
    <a href="#" class="forgot_password"><?php echo $hotaru->lang["admin_theme_login_forgot_password"]; ?></a>
    
    <form style="display: none;" name='forgot_password_form' action='<?php echo BASEURL; ?>admin_index.php' method='post'>    
        <?php echo $hotaru->lang['admin_theme_login_forgot_password_submit_instruct_1']; ?>
    <table>
        <tr>
        <td><?php echo $hotaru->lang["admin_theme_update_email"]; ?>&nbsp; </td>
        <td><input type='text' size=30 name='email' value='<?php echo $email_check; ?>' /></td>
        <td><input type='submit' value='<?php echo $hotaru->lang['admin_theme_login_forgot_password_submit']; ?>' /></td>
        </tr>            
    </table>

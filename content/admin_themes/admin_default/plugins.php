...
$the_plugins = $hotaru->getPlugins(); // don't remove
...
<tr class='table_a'><td colspan=6><?php echo $hotaru->lang["admin_theme_plugins_installed"]; ?></td></tr>
<tr class='table_headers'>
<td><?php echo $hotaru->lang["admin_theme_plugins_on_off"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_plugin"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_order"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_details"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_uninstall"]; ?></td>
</tr>
...
<?php
    ...
    foreach ($the_plugins as $plug) {
        ...
        if ($plug['location'] == 'database') {        
            ...
            echo "<b>" . $hotaru->lang["admin_theme_plugins_description"] . ":</b> " . $plug['description'] . "<br />";
            echo "<b>" . $hotaru->lang["admin_theme_plugins_requires"] . ":</b> ";
            $requires = "";
            foreach ($plug['requires'] as $key=>$value) {
                $requires .= $key . " " . $value . ", ";
            }
            if ($requires != "") { echo rstrtrim($requires, ", "); } else { echo $hotaru->lang["admin_theme_plugins_no_plugins"]; }
            echo "</td>";
...
<tr class='table_b'><td colspan=6><?php echo $hotaru->lang["admin_theme_plugins_not_installed"]; ?></td></tr>
<tr class='table_headers'>
<td><?php echo $hotaru->lang["admin_theme_plugins_off"]; ?></td>
<td colspan=2><?php echo $hotaru->lang["admin_theme_plugins_plugin"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_requires"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_details"]; ?></td>
<td><?php echo $hotaru->lang["admin_theme_plugins_install"]; ?></td>
</tr>
...
<?php
    ...
    foreach ($the_plugins as $plug) {
        ...
        if ($plug['location'] == 'folder') {        
            ...
            echo "<b>" . $hotaru->lang["admin_theme_plugins_description"] . ":</b> " . $plug['description'] . "</td>";
            echo "<td class='table_description_close'><a class='table_hide_details' href='#'>";
            echo $hotaru->lang["admin_theme_plugins_close"] . "</a></td></tr>\n";
        }
    }

...
//        print_r($tweet_this_settings);
        ...
        echo "<p>" . $h->lang['tweet_this_settings_use_GA_tracking'];
		echo ": <input type='checkbox' name='test' " . $tweet_this_settings['tt_use_GA_tracking'] . ">";
		echo " <a href='http://www.google.com/support/googleanalytics/bin/answer.py?hl=en&answer=55518' target='_blank' >" . $h->lang['tweet_this_settings_what_is_GA_tracking'] . "</a>";

...
$widgets = $hotaru->sidebar->getSidebarWidgets();    // gets and sorts plugins by "order"
$sidebars = $hotaru->sidebar->getLastSidebar($widgets);
...
?>
    ...
    <tr class='table_a'><td colspan=6><?php echo $hotaru->lang["sidebar_ordering_title"] . " " . $i; ?> </td></tr>
    <tr class='table_headers'>
    <td><?php echo $hotaru->lang["sidebar_ordering_block_enabled"]; ?></td>
    <td><?php echo $hotaru->lang["sidebar_ordering_block_name"]; ?></td>
    <td><?php echo $hotaru->lang["sidebar_ordering_block_order"]; ?></td>
    </tr>
...
<div id="plugin_management_notice" class="info_box gray_box" style="margin-top: 2.0em";>
    <p class="info_header"><?php echo $hotaru->lang["sidebar_ordering_guide"]; ?></p>
    <?php $hotaru->plugins->pluginHook('sidebar_ordering_guide_top'); ?>
    &raquo; <?php echo $hotaru->lang["sidebar_ordering_guide_1"]; ?><br />
    <?php $hotaru->plugins->pluginHook('sidebar_ordering_guide_bottom'); ?>
</div>

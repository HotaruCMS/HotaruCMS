    ...
    function step2($xml, $file_name)
    {
        ...
        if (!$this->db->table_empty($this_table)) {
            if (!$this->cage->get->getAlpha('overwrite') == 'true') {
                ...
                echo "<a class='next' href='" . BASEURL . "admin_index.php?page=plugin_settings&amp;plugin=pligg_importer&amp;file_name=" . $file_name . "&amp;step=2&amp;overwrite=true'>Continue</a>";
                return false;
            } 
        }
        ...
        echo "<a class='next' href='" . BASEURL . "admin_index.php?page=plugin_settings&amp;plugin=pligg_importer&amp;step=3'>Continue</a>";

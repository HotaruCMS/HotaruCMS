...
/**
 * name: Fetch Image
 * description: Fetch and display thumbnail images from submitted posts
 * version: 0.1
 * folder: fetch_image
 * class: FetchImage
 */
...
class FetchImage
{
    public function post_img_div($content)
    {
    ...
    public function get_post_image ($post_id=0, $width=0, $height=0, $img_script='',$annotate=false)
    {
        /// <summary>

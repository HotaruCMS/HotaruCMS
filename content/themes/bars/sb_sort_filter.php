...
<!-- SORT -->
<div id="sort_box" >
    <a id="sort_box_link" href='#'>Sort & Filter <img src="<?php echo BASEURL; ?>content/themes/bars/images/dropdown.png"></a>
    <ul class="sort_menu" style="display: none;">
    ...
    <ul class="sort_menu" style="display: none;">
        <li><?php echo $h->lang["sb_base_sort_best_from"]; ?></li>

...
<div id="wrapper" class="container_12">
	<div id="top" class="grid_12">
		...
		<!-- TITLE & SLOGAN BLOCKS -->
		<div id="hd_title" class="grid_6 alpha">
			<h1><a href="<?php echo BASEURL; ?>"><?php echo SITE_NAME; ?> - CFiber</a></h1><br />
			<h2>Your #1 Digg Clone and CFiber Theme!!!<br />
				put your Slogan HERE</h2>
		</div>
		<!-- BANNER 125x125 -->
		<div id="hd_block2" class="grid_6 omega">
		<img src="<?php echo BASEURL . 'content/themes/' . THEME . 'images/125x125.jpg'; ?>" alt="Advertising Banner 125x125" />
		<img src="<?php echo BASEURL . 'content/themes/' . THEME . 'images/125x125.jpg'; ?>" alt="Advertising Banner 125x125" />		
		<img src="<?php echo BASEURL . 'content/themes/' . THEME . 'images/125x125.jpg'; ?>" alt="Advertising Banner 125x125" />
		</div><div class="clear">&nbsp;</div>
	</div>

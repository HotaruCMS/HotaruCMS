...
Please visit http://docs.hotarucms.org/Getting_Started#Installing_and_Upgrading for
the most up-to-date version of these instructions.
...
---------
 ...
 4. Overwrite ALL the old files. If you've made any customizations, read this
    first: http://docs.hotarucms.org/File_Organization
...
-----------------------
 ...
 8. Go to `/install/install.php` and follow the steps
...
--------------------
 ...
 3. Download plugins from the Plugin Downloads forum, unzip and upload them to
...
If you want to use friendly urls, rename `htaccess_default` to `.htaccess`, and
edit it according to the instructions within the htaccess file. Then go
to **Admin -> Settings** and change the **Friendly URLs** setting to true.

Troubleshooting
---------------

If you're having trouble installing Hotaru, please post your questions with as
much detail as possible in the forums at http://hotarucms.org. Thanks.
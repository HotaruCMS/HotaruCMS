...
//                $regex .= '$&i';
    ...
    /**
     * MakeFriendlyUrl
     * Makes a friendly url, e.g. "this-is-a-friendly-url"
     *
     * @param string
     * @return string
     */
    ...
    /**
     * SanitizeMixedString1
     * Sanitize input for display to the browser
     *
     * @param string
     * @return string
     */
    ...
    /**
     * SanitizeMixedString2
     * Sanitize input for saving to the database or condition testing
     *
     * @param string
     * @return string
     */

 ...
 * @return bool
 */
function srch_theme_index_replace()
{
    global $hotaru, $cage;
 ...
 */
function srch_submit_list_filter()
{
 ...
 */
function prepare_search_filter($search)
{
 ...
 */
function explode_search($column, $search_terms)
{
    $query = '';

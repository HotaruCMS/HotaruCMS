...
/* ******************************************************************** 
 * Function: make_url_friendly
 * Parameters: a post title
 * Purpose: convert it to a dash separated surl friendly string
 * Notes: Returns the url friendly string.
 * 	  These functions seem to overlap each other a bit...
 ********************************************************************** */
 ...
 * Parameters: string
 * Purpose: replaces awkward symbols and ascii characters with simpler alternatives
 * Notes: Additional characters can be added to this function.
 *	  Adapted from SWCMS
 ********************************************************************** */
 
function replace_symbols($input) {
	
	// FOR THIS TO WORK, THIS FUNCS.STRINGS.PHP FILE MUST BE SAVED IN UTF-8 CHARACTER ENCODING
		
	$output = preg_replace('/\s+/' , '-' , $input); // Replace spaces with hyphens
 ...
 * Parameters: string
 * Purpose: Gets rid of any dangerous or unwanted characters
 * Notes: Borrowed from Wordpress
 ********************************************************************** */
 ...
 * Parameters: string
 * Purpose: Remobes accents from characters
 * Notes: Borrowed from Wordpress
 ********************************************************************** */
 ...
 * Function: seems_utf8
 * Parameters: string
 * Purpose: Determines if the string is utf8
 * Notes: Borrowed from Wordpress
 ********************************************************************** */

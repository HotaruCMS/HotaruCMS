...
<form name='search_form' id='search_form' action='<?php echo BASEURL; ?>index.php?page=search' method='get'> 
    <input id="search_input" type="text" value="<?php echo $lang['search_text']; ?>" size="15" name="search" id="searchsite" 
        onblur="if (this.value == '') {this.value = '<?php echo $lang['search_text']; ?>';}"  

...
// Paths
define('BASEURL', "http://ipadrank.com/");		// e.g. http://example.com/ (needs trailing cache)

// Database details
define("DB_USER", 'ipadrank_admin01');						// Add your own database details 
define("DB_PASSWORD", '_68TW(;l*)k8');
define("DB_NAME", 'ipadrank_hotaru');

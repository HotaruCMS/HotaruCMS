...
<legend><?php echo $lang['install_step2']; ?></legend>
    ...
    <div class="progress progress-info">
		...
		<form name='install_admin_reg_form' action='index.php?step=2' method='get'>
                    ...
                    <input class='btn btn-primary' class='button' type='submit' value='<?php echo $lang['install_step2_form_delete_confirm']; ?>' />
                    </div>
                </form>

		<div class='install_content'>
                    <?php echo $lang['install_step2_existing_go_upgrade1']; ?>
                    <a class="btn btn-link" href='?step=1&action=upgrade'>
